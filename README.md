...
- I worked on the following recently:
      - Database Backup and Restoration to AWS S3 for Microsoft SQL Database
      - Deployment of Flask App to Production using AWS Elastic Beanstalk
      - Two-Tier WordPress Application Deployment on AWS for MercyReads
      - Setting Up AWS CLI for EpicReads Organizations and Managing s3 buckets and Objects with AWS CLI for the organization
  
- 🌱 I’m currently learning
      - several AWS-based project scenarios and
      - other cloud architecture best practices
